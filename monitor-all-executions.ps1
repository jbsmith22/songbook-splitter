# Monitor all executions (corrected + found + retry)
...
Write-Host "Monitoring All Executions" -ForegroundColor Cyan
Write-Host "================================================================================" -ForegroundColor Cyan
Write-Host ""
...
if ($succeededExecutions.Count -gt 0) {
    Write-Host "Succeeded Executions: $($succeededExecutions.Count)" -ForegroundColor Green
    Write-Host ""
}
